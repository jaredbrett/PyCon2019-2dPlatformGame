...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.collect_gem_sound = arcade.load_sound("sounds/coin5.wav")
    ...
    def setup(self, level):
        ...
        #Name of the layer that has gems
        gems_layer_name = 'Gems'

        # Map name
        map_name = "sample_game_map.tmx"
        ...
        self.gem_list = arcade.generate_sprites(my_map, gems_layer_name, TILE_SCALING)
