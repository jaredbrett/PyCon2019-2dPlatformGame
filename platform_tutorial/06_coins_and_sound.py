...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.collect_gem_sound = arcade.load_sound("sounds/coin1.wav")
    ...
    def setup(self):
        ...
        for x in range(1300, 1500, 64):
            wall = arcade.Sprite("images/tiles/grassMid.png", TILE_SCALING)
            wall.center_x = x
            wall.center_y = -32
            self.wall_list.append(wall)
        
        for x in range(1650, 1725, 64):
            wall = arcade.Sprite("images/tiles/grassMid.png", TILE_SCALING)
            wall.center_x = x
            wall.center_y = -32
            self.wall_list.append(wall)
        ...
        for x in range(1778, 1800, 256):
            gem = arcade.Sprite("images/items/gemBlue.png", COIN_SCALING)
            gem.center_x = x
            gem.center_y = 120
